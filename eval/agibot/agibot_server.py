...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_local_vlm', type=int, default=0)
    parser.add_argument('--use_proprioception', type=int, default=0)
    ...
    server_model = build_xvla(
        ...
        use_local_vlm=bool(args.use_local_vlm), 
        use_proprioception=bool(args.use_proprioception),
